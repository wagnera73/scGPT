# %% [markdown]
# # Condition Prediction on AML Data

# %% [markdown]
# ## Using the batch integration tutorial as a starting point, finetuning scGPT with AML data to perform condition prediction. 
...
script_path = os.path.join(os.getcwd(), 'finetune_AML_condition.ipynb')  # Or adjust for your specific case
...
# %% [markdown]
# ## 2.4 Tokenize input data for finetuning

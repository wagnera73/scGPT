...
pert_data.load(data_name="aml", data_path = "./data/aml")
...
def plot_perturbation(
    ...
    # Alternative if .gene_names isn't available:
    evagene2idx = {gene: i for i, gene in enumerate(pert_data.adata.var_names)}
